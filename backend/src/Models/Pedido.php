...
class Pedido
{
    ...
    public function create(array $data): int
    {
        $stmt = $this->pdo->prepare(
            'INSERT INTO pedidos
             (cliente_id, repartidor_id, direccion_entrega, latitud, longitud, estado, created_at, updated_at)
             VALUES (:cliente_id, :repartidor_id, :direccion_entrega, :latitud, :longitud, :estado, NOW(), NOW())'
        );
        $stmt->execute([
