...
class PedidoController
{
    ...
    public function index(): void
    {
        ...
        if ($user->rol === 'cliente') {
            ...
            $filters['empresa_id'] = TenantHelper::empresaId($user);
        } else {
    ...
    public function store(): void
    {
        ...
        TenantHelper::verifyUsuarioEmpresa($cliente, $empresaId);
        ...
        if ($user->rol === 'admin') {
            if (!empty($data['repartidor_id'])) {
                ...
                TenantHelper::verifyUsuarioEmpresa($repartidor, $empresaId);
    ...
    public function update(int $id): void
    {
        ...
        $updateData = [];
        $empresaId = $user->rol === 'admin' ? TenantHelper::empresaId($user) : null;
    ...
    public function destroy(int $id): void
    {
        ...
        TenantHelper::verifyPedidoEmpresa($pedido, $empresaId);
    ...
    {
        if ($user->rol === 'admin') {
            TenantHelper::verifyPedidoEmpresa($pedido, TenantHelper::empresaId($user));
            return;
        }
